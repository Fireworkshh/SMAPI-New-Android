# SMAPI Android Loader

![SMAPI Android Loader Logo](https://github.com/Fireworkshh/SMAPI-New-Android/blob/master/Resources/Drawable/ic_launcher.png)

SMAPI Android Loader 是一个用于在 Android 设备上加载和管理 Stardew Valley Mods 的工具。

## 功能

- 支持 Stardew Valley 的 Android 版本的 Mods 加载
- 提供方便的用户界面来管理和配置 Mods
- 与 PC 版 SMAPI 兼容
- 简单易用的安装和设置步骤

## 安装

1. **下载**: 从 [Releases](https://github.com/Fireworkshh/SMAPI-New-Android/releases) 页面获取最新版本。
2. **安装**: 将下载的文件复制到您的设备并运行。
3. **配置**: 按照应用内的指引步骤配置您的游戏路径和 Mods 目录。

## 用法

1. 打开 SMAPI Android Loader 应用。
2. 浏览和选择要加载的 Mods。
3. 点击 "启动游戏" 按钮享受您的游戏体验。

## 常见问题

- **如何找到游戏数据路径？** 模组路径放在 `/storage/emulated/0/Android/data/app.SMAPIStardew/Mods` 下。
- **Mods 不工作怎么办？** 确保您的 Mods 兼容 Stardew Valley 的 Android 版本，并且已正确放置于 `Mods` 文件夹中。

## 贡献

我们欢迎对项目进行改进和扩展。请查看 [CONTRIBUTING.md](https://github.com/Fireworkshh/SMAPI-New-Android/blob/main/CONTRIBUTING.md) 获取详细信息。

## 许可证

此项目根据 [MIT License](LICENSE) 许可。

## 支持

如需帮助，请访问 [GitHub Issues](https://github.com/Fireworkshh/SMAPI-New-Android/issues) 提交问题。

---

感谢您使用 SMAPI Android Loader，如有任何意见或建议，欢迎与我们联系！
...
5. 项目地址已经开源 [GitHub Repository](https://github.com/Fireworkshh/SMAPI-New-Android)。
6. 哔哩哔哩 UP 主是 [猫离个喵哦](https://b23.tv/zVL6x1g)。
...
6. Bilibili UP主 is [猫离个喵哦](https://b23.tv/zVL6x1g).
